...
# Keep declarations from Windows until generate after deploy
...
echo "=== deploy ice (categories) ==="
dfx deploy ice --network ic --yes

echo "=== refresh IDL from canister build ==="
...
# Mirror back to Windows workspace
...
echo "=== smoke query categories ==="
dfx canister call ice getCategories --network ic || true

echo "DONE — categories live"
